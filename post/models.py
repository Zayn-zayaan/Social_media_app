...
class Follow(models.Model):
    ...
    def user_follow_notify(instance, sender, *args, **kwargs):
        follow  = instance
    ...
    def user_unfollow_notify(instance, sender, *args, **kwargs):
        follow  = instance
        sender = follow.follower
        following  = follow.following
...
class Stream(models.Model):
    ...
    def add_post(instance, sender, *args, **kwargs):
        post = instance
        user = post.user
...
class Likes(models.Model):
    ...
    def user_liked_post(instance, sender, *args, **kwargs):
        like = instance
        post = like.post
        sender = like.user
    ...
    def user_unliked_post(instance, sender, *args, **kwargs):
        like = instance
        post = like.post
        sender = like.user
...
# follow notification 
post_save.connect(Follow.user_follow_notify, sender=Follow)
post_delete.connect(Follow.user_unfollow_notify, sender=Follow)